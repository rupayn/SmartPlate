    ...
    <div className="relative text-black mt-24">
      ...
      >
        <div>
          ...
          <ul>
            <li className="border-b-2 py-4 hover:border-zinc-900 hover:bg-white/30 hover:text-lg pl-2 hover:backdrop-blur-sm hover:font-semibold">
              Item
            </li>
        ...
        <div className="bottom-0 float-end">
          ...
          {user ? (
            ...
            >
              <FontAwesomeIcon className="text-4xl mr-5" icon={faCircleUser} />
